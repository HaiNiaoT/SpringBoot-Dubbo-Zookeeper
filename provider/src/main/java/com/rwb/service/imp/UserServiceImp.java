 ...
 * */
@Service(cluster = "failfast",timeout = 50000,loadbalance = "consistenthash",group = "rwb")
public class UserServiceImp implements UserService {
    ...
    public String SayBay(String name) {
        ...
        log.info("getAttachment {}",context.getAttachment("index"));

        log.info("Bay {},request address {}",name, context.getRemoteAddress());

        return String.format("Bay %s,response address %s",name,context.getLocalAddress());
    }
}
